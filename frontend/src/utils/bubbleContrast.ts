...
const TABLE_DARK =
  '[&_table]:w-full [&_table]:border-collapse [&_table]:my-1 [&_table]:rounded-lg [&_table]:overflow-hidden [&_table_th]:text-white [&_table_td]:text-white/85 [&_table_th]:py-1.5 [&_table_td]:py-1.5 [&_table_th]:px-3 [&_table_td]:px-3 [&_table_th]:border [&_table_td]:border [&_table_th]:border-white/20 [&_table_td]:border-white/20 [&_table_th]:text-left [&_table_th]:font-semibold [&_table]:bg-primary-700/30 [&_table_th]:bg-primary-700/40 [&_table_tr:nth-child(even)]:bg-primary-700/20 [&_table_tr]:hover:bg-primary-700/50 [&_table_tr]:transition-colors'
...
const CODE_LIGHT = ''
const TABLE_LIGHT =
  '[&_table]:w-full [&_table]:border-collapse [&_table]:my-1 [&_table]:rounded-lg [&_table]:overflow-hidden [&_table_th]:text-textPrimary [&_table_td]:text-textSecondary [&_table_th]:py-1.5 [&_table_td]:py-1.5 [&_table_th]:px-3 [&_table_td]:px-3 [&_table_th]:border [&_table_td]:border [&_table_th]:border-border [&_table_td]:border-border [&_table_th]:text-left [&_table_th]:font-semibold [&_table]:bg-surface [&_table_th]:bg-canvas [&_table_tr:nth-child(even)]:bg-elevated [&_table_tr]:hover:bg-elevated/80 [&_table_tr]:transition-colors'
