...
**八种预设彩色文字**：通过 HTML `<span class="text-颜色">` 标签实现。支持 `red`、`orange`、`gold`、`green`、`blue`、`purple`、`pink`、`gray` 八色。深色气泡和浅色气泡各自适配对应亮度版本（CSS 变量 `--b-text-*` 控制），确保始终可读。
...
| [AI 上下文状态管理设计](./ai-context-state-design.md) | 开发者 | 状态栈、群级 DND、enter_group、end_turn 恢复、TODO/PLAN/JOURNAL 整合 |
