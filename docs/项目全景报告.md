...
> **版本**: v2.1.0 | **更新**: 2026-07-03 | **阶段**: 预发布（功能完整，持续迭代）
>
...
### 3.10 🔕 群级 DND 增强（v2.1.0）

v2.1.0 增强了 per-group 的免打扰穿透规则：
...
| **状态栈** | 2 | 🟢 稳定 | v2.1.0: push/pop/close/list 状态帧 + end_turn 持久化 + workspace 联动 |
