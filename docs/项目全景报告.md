...
> **版本**: v1.0.1 | **更新**: 2026-07-03 | **阶段**: 预发布（功能完整，持续迭代）
>
...
| 技能段 | 工具数 | 代表工具 | 适用状态 |
|--------|--------|---------|----------|
| 群聊社交 | 10 | send_message, send_dm, send_file, set_dnd, cancel_dnd, enter_group | active |
...
| 自我管理 | 7 | end_turn, push_state, pop_state, close_state, list_states, check_workspace, manage_workspace | 全状态 |

| AI 状态 | 可用工具数 | 说明 |
|----------|-----------|------|
| active | 37 | 全部工具 |
| dnd | 26 | 排除社交主动工具，仍可管理自我 |
| offline | 14 | 含状态栈全套工具 |
| blocked | 0 | 完全封禁 |
...
flowchart TB
    ...
    subgraph Tools["🔧 工具系统 · 37 tools in 6 segments"]
        direction LR
...
| **工具系统** | 25 | 🟢 稳定 | 37 个工具、6 个技能段、ToolPlugin 基类、自动注册 |
