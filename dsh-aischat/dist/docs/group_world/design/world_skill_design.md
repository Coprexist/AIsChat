...
> 2026-08-06 落地。产品确认方向：世界能力走"skill/tools 放文件夹让实例识别"，
...
## 三·六、Skill 分层注入（按 AI 类型分发，2026-08-12 产品定）
...
### Skill 设计准则（2026-08-12 产品定，给 AI 的 skill 必须考虑）

> 产品原话："请考虑 skill 给到 AI 后 AI 的可操作性和简便性，和一次 skill 能实现效果的最大化性"
