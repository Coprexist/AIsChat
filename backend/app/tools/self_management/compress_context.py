...
class CompressContext(ToolPlugin):
    ...
    async def execute(self, db: AsyncSession, agent_id: int, group_id: int | None,
        ...
        # 检查是否需要压缩
        if not force:
            from app.services.context_compression_service import should_compress, estimate_tokens
        ...
        # 执行压缩
        from app.services.context_compression_service import compress_messages
